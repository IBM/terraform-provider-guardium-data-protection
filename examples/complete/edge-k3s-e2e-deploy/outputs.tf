...
# Complete K3S Edge Deployment Outputs
...
output "k3s_nodes" {
  description = "List of K3S node hostnames"
  value       = var.k3s_nodes
}

output "k3s_master_node" {
  description = "K3S master node hostname"
  value       = var.k3s_master_node
}
...
output "k3s_primary_master" {
  ...
  value       = var.install_k3s ? guardium-data-protection_k3s_cluster.main[0].primary_master : var.k3s_master_node
}
...
output "access_instructions" {
  ...
  value       = <<-EOT
    ...
    1. SSH to the primary master node:
       ssh ${var.ssh_user}@${var.k3s_master_node}
...
output "quick_access" {
  ...
  value       = "ssh ${var.ssh_user}@${var.k3s_master_node}"
}
